...
interface NotificationContextType {
  ...
  addNotification: (message: string, type: NotificationMessage["type"], details?: string) => void;
...
export const NotificationProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const addNotification = useCallback((message: string, type: NotificationMessage["type"], details?: string) => {
